...
# 2. Start (Auto-setup mode will trigger if credentials are missing)
npm start
```

The connector will walk you through setting your `AGENT_ID` and `PLATFORM_KEY` on first run and save them to a `.env` file for you.
